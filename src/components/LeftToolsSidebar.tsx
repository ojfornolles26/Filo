                ...
                {activeCropFile ? (
                  isCropping ? (
                    ...
                    >
                      ...
                      {/* Action buttons */}
                      <div className="flex flex-col gap-2 pt-3 border-t border-stone-200/40 dark:border-stone-800/30">
                        <div className="flex gap-2">
                          <button
                            type="button"
                            onClick={onCropReset}
                            className="flex-1 py-2 text-[11px] rounded border border-stone-200 dark:border-stone-800 bg-white hover:bg-stone-50 dark:bg-stone-950 dark:hover:bg-stone-900 text-stone-600 dark:text-stone-400 font-medium flex items-center justify-center gap-1 cursor-pointer focus:outline-none transition-colors"
                          >
                        ...
                        <button
                          type="button"
                          onClick={onCropSave}
                          className="w-full py-2 text-[11px] rounded bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-400 text-white font-bold flex items-center justify-center gap-1 border border-blue-600 dark:border-blue-500 cursor-pointer focus:outline-none transition-colors shadow-xs"
                        >
                        ...
                        <div className="p-4 border border-stone-200/50 dark:border-stone-800/40 bg-stone-50/15 dark:bg-stone-950/20 rounded-xl space-y-3">
                          ...
                          <div className="space-y-2 text-xs">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                              ...
                              <div>
                                <span className="text-stone-400 dark:text-stone-500 block text-[10px] uppercase">Format</span>
                                <span className="font-semibold text-stone-700 dark:text-stone-300 block uppercase">{activeCropFile.type.split('/')[1]}</span>
                              </div>
                            </div>
                          </div>
                        </div>

                        <p className="font-sans text-[11px] text-stone-500 dark:text-stone-400 leading-relaxed bg-blue-50/10 dark:bg-blue-950/10 p-3 rounded-lg border border-blue-100/30 dark:border-blue-950/30">
                          This image will be compiled into the PDF using its original dimensions and layout.
                        </p>

                        <button
                          type="button"
                          onClick={() => setIsCropping(true)}
                          className="w-full py-2.5 px-4 text-xs rounded-lg bg-stone-900 hover:bg-stone-800 dark:bg-stone-100 dark:hover:bg-white text-white dark:text-stone-900 font-semibold flex items-center justify-center gap-2 border border-stone-900 dark:border-stone-100 cursor-pointer focus:outline-none transition-all shadow-xs"
                        >
                  ...
                  <motion.p
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-xs text-stone-400 dark:text-stone-500 italic mt-4"
                  >
            ...
            <div className="space-y-5">
              ...
              {activePdf ? (
                <div className="space-y-4">
                  ...
                  <div className="border border-stone-200/50 dark:border-stone-800/40 bg-stone-50/15 dark:bg-stone-950/20 rounded-xl p-4 flex flex-col items-center justify-center text-center space-y-3">
